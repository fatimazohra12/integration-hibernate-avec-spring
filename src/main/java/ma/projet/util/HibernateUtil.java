...
@Configuration
@ComponentScan(basePackages = {"ma.projet.dao", "ma.projet.classes", "ma.projet.services"})
@EnableTransactionManagement  // Active la gestion des transactions
@PropertySource("classpath:application.properties")  // Charger explicitement le fichier
